...
edfi_repos = ["Ed-Fi-Alliance-OSS/Ed-Fi-ODS-AdminApp", "Ed-Fi-Alliance-OSS/Ed-Fi-API-Publisher", "Ed-Fi-Alliance-OSS/Ed-Fi-AdminAPI", "Ed-Fi-Alliance-OSS/AdminAPI-2.0", "Ed-Fi-Alliance-OSS/Ed-Fi-DataImport", "Ed-Fi-Alliance-OSS/Roster-Starter-Kit-for-Vendors", "Ed-Fi-Alliance-OSS/Ed-Fi-LearningStandards-Client"]
...
page_title = "Tools Portfolio - Product Dependabot Alerts"
page = confluence.get_page_by_title(title=page_title, space="OTD")
